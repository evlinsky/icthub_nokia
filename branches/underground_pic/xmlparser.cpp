...
xmlParser::xmlParser( QFile* file, QVector<Station>* stations, QVector<Edge>* edges,double *mapHeight,double *mapWidth, double *fontSize, QString &mapDir,QString &mapPastelDir )
{
    StLst = stations;
    EdLst = edges;
