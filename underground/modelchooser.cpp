...
QVariantList ModelChooser::getRouteStations(QVariantList route)
{
    return models[state]->getRouteStations(route);
}
QVariantList ModelChooser::getRouteEdges(QVariantList route)
{
    return models[state]->getRouteEdges(route);
}
QVariantList ModelChooser::getAllEdges(){
    return models[state]->getAllEdges();
}
QVariantList ModelChooser::getRects(){
    return models[state]->getRects();
}
